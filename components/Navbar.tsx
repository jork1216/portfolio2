      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[100] bg-[#bdecfd] p-5 font-sans font-black uppercase text-black min-[1025px]:hidden">
          ...
          <div className="mt-16 flex flex-col gap-3">
            ...
            <button className="mt-2 flex items-center justify-between rounded-lg border-3 border-black bg-yellow-300 px-5 py-4 text-xl shadow-[4px_4px_0_#000]">
              <span className="flex items-center gap-4">
                <PhoneIcon />
...
function CloseIcon() {
  return (
    <svg aria-hidden="true" className="h-12 w-12" viewBox="0 0 48 48" fill="none">
      <path d="M12 12 36 36M36 12 12 36" stroke="black" strokeWidth="10" strokeLinecap="round" />
